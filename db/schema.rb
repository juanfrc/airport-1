...
ActiveRecord::Schema.define(version: 20150309214235) do
  ...
  create_table "departues", force: true do |t|
    t.integer  "flight_id"
    t.datetime "date"
    t.integer  "status"
    t.datetime "created_at"
  ...
  add_index "departues", ["flight_id"], name: "index_departues_on_flight_id"
